...
if CONDA_PREFIX:
    if os.name == 'nt':
        ...
        # Linux/Unix path
        GDAL_LIBRARY_PATH = os.path.join(CONDA_PREFIX, 'lib', 'libgdal.so')
...
# MFD_WEBSITE_URL="https://dhm.gov.np/mfd/"

# Partial settings.py with relevant additions
...
MEDIA_ROOT = 'media/'
MFD_WEBSITE_URL = 'http://127.0.0.1:8000'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs', 'debug.log'),  # Adjust path as needed
            'formatter': 'verbose',
        }, 
    },
    'loggers': {
        'analysis': {  # Matches logger = logging.getLogger(__name__) in analysis app
